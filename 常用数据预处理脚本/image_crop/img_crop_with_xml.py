...
class_list = ['coarse', 'crease', 'hole', 'dusty']  #clw modify

cropped_width = 1024
cropped_height = 1024

step = 768  # clw note：这里实际上不是overlap，而是step = 图片尺寸-overlap，即步进长度


#raw_data = 'C:/Users/Administrator/Desktop/GC1/'  # clw note：主要就是配置好训练集的路径
xml_and_img_path = 'F:/GC2/'

save_dir = xml_and_img_path + 'train_crop/'  # clw note：out

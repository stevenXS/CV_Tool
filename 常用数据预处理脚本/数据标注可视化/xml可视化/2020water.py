...
ImgPath = 'D:/underwater/image/'
AnnoPath = 'D:/underwater/image/'

save_path = 'D:/underwater/save/'
    ...
    for i, image in enumerate(imagelist):
        ...
        for objects in objectlist:
            ...
            for box in bndbox:
                ...
                cv2.putText(img, objectname, (int(x1), int(y1)), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 255),thickness=1)
        ...
        cv2.imwrite(os.path.join(save_path, image), img)  # save picture

...
def cloth_train_data(train_path=None, valid_path = None, test_path = None):
    # classes = ['car', 'skateboard', 'zebra', 'frisbee', 'skis', 'sports ball', 'parking meter', 'kite', 'bear', 'fire hydrant', 'bird', 'baseball bat', 'dog', 'cat', 'sheep', 'traffic light', 'snowboard', 'surfboard', 'person', 'tennis racket', 'stop sign', 'baseball glove', 'giraffe', 'horse', 'bench', 'cow', 'elephant']
    # class2indice = {"car":0, 'skateboard': 1, 'zebra': 2, 'frisbee': 3, 'skis': 4, 'sports ball': 5, 'parking meter': 6, 'kite': 7, 'bear': 8, 'fire hydrant': 9, 'bird': 10, 'baseball bat': 11, 'dog': 12, 'cat': 13, 'sheep': 14, 'traffic light': 15, 'snowboard': 16, 'surfboard': 17, 'person': 18, 'tennis racket': 19, 'stop sign': 20, 'baseball glove': 21, 'giraffe': 22, 'horse': 23, 'bench': 24, 'cow': 25, 'elephant': 26}

...
src_json_file = "D:/2020water/train/annotations.json"
...
categ_infos = sorted(categ_infos, key = lambda e:e.get('id'),reverse = False)  # clw note：否则mmdetection默认类别顺序可能是1,9,2......注意未排序之前可能就是1,9,2这种
...
category_ids = [1,2,3,4]  # 这个不影响，只要需要分验证集的类里面有就行
img_format = '.jpg'

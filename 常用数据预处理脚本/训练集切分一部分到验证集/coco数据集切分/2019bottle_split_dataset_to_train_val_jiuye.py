...
src_json_file = "C:/Users/62349/Downloads/merge/annotations_jiuye.json"
...
img_nums_in_one_group = 5
val_split_ratio = 0.2
assert img_nums / img_nums_in_one_group == img_nums // img_nums_in_one_group
class_split_ratio_min = 0.18   # 每一类在验证集的object个数不能少于0.15，
class_split_ratio_max = 0.22  # 每一类在验证集的object个数不能多于0.25
...
while(1):
    ...
    a = random.randint(0, 1800) // img_nums_in_one_group * img_nums_in_one_group
    val_index = list(range(a,  a+ int(img_nums*0.2)))
